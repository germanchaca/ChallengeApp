 ...
 * @author Yaniv Inbar
 */
abstract class YoutubeAsyncTaskProof extends AsyncTask<Void, Integer, Video> {

  static final String TAG = "YoutubeSampleActivity";
  final SubmitProofActivity activity;
  final com.google.api.services.youtube.YouTube youtube;
//  private final View progressBar;
  final TextView textViewStatus;
  YoutubeAsyncTaskProof(SubmitProofActivity activity) {
